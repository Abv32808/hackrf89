...
//					hwFullSpectrumRefreshes, chartRedrawed, timeSpentDrawingChartPerSec);
	...
	private ModelValueInt							parameterGainVGA					= new ModelValueInt("VGA Gain", 0, 2, 0, 20);
	...
	private ModelValueBoolean						parameterSpurRemoval				= new ModelValueBoolean("Spur removal", true);
...
//			parameterFrequency.setValue(new FrequencyRange(700, 2700));
	...
	private void processingThread() {
		...
		//while(true)
		{
			 ...
			 */
			int limitChartRefreshFPS		= 15;
			int limitPersistentRefreshEveryChartFrame	= 4;
